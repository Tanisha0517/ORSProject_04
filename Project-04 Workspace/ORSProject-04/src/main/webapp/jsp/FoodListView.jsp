...
<body class="bg-light">
	...
	List<FoodBean> list = ServletUtility.getList(request);
	Iterator<FoodBean> it = list.iterator();
	String _suc = ServletUtility.getSuccessMessage(request);
	String _err = ServletUtility.getErrorMessage(request);
	%>

	<form action="<%=ORSView.FOOD_LIST_CTL%>" method="post">
			...
			<div class="card shadow-sm border-0">
				...
				<div class="card-header bg-white text-center border-bottom py-4">
					<h2 class="text-primary fw-bold mb-0">
						<i class="fa-solid fa-user-shield"></i> Food List
					</h2>
				</div>
					...
					<div class="row g-2 mb-4">
						...
						<div class="col-md-4">
							<input type="text" name="restaurant" value=""
								class="form-control" placeholder="search by restaurant">
						</div>
						<div class="col-md-2">
						...
						<table class="table table-bordered table-hover align-middle">
							...
							<tbody>
								...
								<tr class="text-center">
									...
									<td><%=bean.getRestaurant()%></td>
									<td><%=bean.getOrderAmount()%></td>
									<td><%=bean.getDeliveryStatus()%></td>
									<td><a class="btn btn-sm btn-outline-primary"
										href="<%=ORSView.FOOD_CTL + "?id=" + bean.getId()%>">
